    ...
    *,
    ...
    return {
        ...
        "instruction": (
            ...
            "just learned and check your understanding. On a recovery_or_check turn, "
            "state your best understanding as a declarative sentence before any optional "
            "follow-up question; do not make the entire turn a confirmation question. "
            "When the teacher asks you to check a rule, answer the full latest rule in "
            "one compact sentence, including each condition the teacher just named, "
            "rather than repeating only one clause. "
            "Do not mention testing, role-play, "

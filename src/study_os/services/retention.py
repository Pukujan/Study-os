"""Validation and result projection for retention-probe closure."""
...
def validate_scheduled_probe(
    ...
    *,
    ...
    if probe.get("concept_id") != capability:
        raise integrity(
            "Retention assessment capability does not match the scheduled probe concept",
            retention_probe_id=retention_probe_id,
            probe_concept_id=probe.get("concept_id"),
            assessment_capability=capability,
        )
    return probe
